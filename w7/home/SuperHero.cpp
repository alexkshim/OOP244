...
namespace sict {
	...
	{
		this->m_superPowerAttackBonus = superPowerAttack;
		this->m_superPowerDefendBonus = superPowerDefend;
	}
	...
	{
		return Hero::getAttack() + this->m_superPowerAttackBonus;
	}
	...
	{
		return this->m_superPowerDefendBonus;
	}
